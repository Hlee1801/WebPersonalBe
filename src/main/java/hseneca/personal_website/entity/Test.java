...
//
//    public void insert() {
//        List<String> schools = List.of("FPT", "HUST", "FTU", "NEU", "NUC", "DCM");
//        int batchSize = 10000; // batch size for saving to avoid memory issues
...
//                    .school(schools.get(rand.nextInt(schools.size())))
////                    .contact(contact)
////                    .projects(projects)
